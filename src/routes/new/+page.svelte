<script>
    ...
    function addLine() {
        ...
        counter += 1
        tbody.insertAdjacentHTML("beforeend", `<tr class="s-SUdKbrhE3DBq"><td class="s-SUdKbrhE3DBq"># ${counter}</td><td class="s-SUdKbrhE3DBq"><input class="inputs s-SUdKbrhE3DBq" type="text" class="inputs"></td><td class="s-SUdKbrhE3DBq"><input class="inputs s-SUdKbrhE3DBq" type="text" class="inputs"></td></tr>`);
    ...
    function saveData() {
      ...
      if (title === "email" || title === "fullname") {
        ...
        alert("Title can't be longer than 100 characters!");
        return;
      }
